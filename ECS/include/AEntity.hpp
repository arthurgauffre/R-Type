...
namespace entity
{
    ...
    public:
        /**
         * @brief Constructs an AEntity object with a specified ID and sets it as active.
         *
         ...
         *
         * This function overrides the base class implementation to set the active state
         * of the entity. When an entity is active, it is considered in use and will be
         * processed by the system. When inactive, it will be ignored.
         *
    ...
    protected:
         ...
         *
         * This ID is used to distinguish each entity within the ECS (Entity Component System).
         */
        uint32_t id;
         ...
         *
         * This boolean flag is used to determine if the entity is active and should be processed
         * in the game loop. If set to true, the entity is active; if false, the entity is inactive.
         */
        bool isActive;
    };
}

...
namespace ECS_system
{
    ...
    public:
         ...
         * @param window Reference to the SFML RenderWindow where the rendering will take place.
         */
         ...
         *
         * This function is an override of the base class method and is responsible for
         * managing the components that are relevant to the rendering system. The actual

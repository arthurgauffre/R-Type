...
namespace component
{
    ...
    public:
         ...
         * It is typically called once per frame with the time elapsed since the last frame.
         *
    ...
    private:
         ...
         *
         * This component encapsulates an sf::Sound object, which is used to play audio in the game.
         * The sf::Sound class provides functionalities to control the playback of sound effects.
         *
         * @see sf::Sound
         */
        sf::Sound _sound;

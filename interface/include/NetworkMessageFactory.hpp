...
public:
    ...
    rtype::network::Message<NetworkMessages> createTextureMsg(std::string texturePath)
    {
        rtype::network::Message<NetworkMessages> message;
        ...
        message.body.insert(message.body.end(), textureBytes.begin(), textureBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createPositionMsg(float x, float y)
    {
        ...
        message.body.insert(message.body.end(), positionBytes.begin(), positionBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createVelocityMsg(float x, float y)
    {
        ...
        message.body.insert(message.body.end(), velocityBytes.begin(), velocityBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createHealthMsg(int health)
    {
        ...
        std::vector<uint8_t> healthBytes(reinterpret_cast<uint8_t *>(&healthComponent),
                                          reinterpret_cast<uint8_t *>(&healthComponent) +
                                              sizeof(HealthComponent));
        message.body.insert(message.body.end(), healthBytes.begin(), healthBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createDamageMsg(int damage)
    {
        ...
        std::vector<uint8_t> damageBytes(reinterpret_cast<uint8_t *>(&damageComponent),
                                          reinterpret_cast<uint8_t *>(&damageComponent) +
                                              sizeof(DamageComponent));
        message.body.insert(message.body.end(), damageBytes.begin(), damageBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createHitboxMsg(float x, float y)
    {
        ...
        message.body.insert(message.body.end(), hitboxBytes.begin(), hitboxBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createMusicMsg(std::string musicPath)
    {
        rtype::network::Message<NetworkMessages> message;
    ...
    rtype::network::Message<NetworkMessages> createSoundMsg(std::string soundPath)
    {
        rtype::network::Message<NetworkMessages> message;
    ...
    rtype::network::Message<NetworkMessages> createSpriteMsg(float x, float y)
    {
        ...
        message.body.insert(message.body.end(), spriteBytes.begin(), spriteBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createTransformMsg(float x, float y, float scaleX, float scaleY)
    {
        rtype::network::Message<NetworkMessages> message;
        message.header.id = NetworkMessages::createTransform;
        TransformComponent transform = {x, y, scaleX, scaleY};
        std::vector<uint8_t> transformBytes(reinterpret_cast<uint8_t *>(&transform),
                                             reinterpret_cast<uint8_t *>(&transform) +
                                                 sizeof(TransformComponent));
        message.body.insert(message.body.end(), transformBytes.begin(), transformBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createBackgroundMsg(std::string texturePath, float x, float y)
    {
        rtype::network::Message<NetworkMessages> message;
        message.header.id = NetworkMessages::createBackground;
        BackgroundComponent background = {texturePath, x, y};
        std::vector<uint8_t> backgroundBytes(reinterpret_cast<uint8_t *>(&background),
                                              reinterpret_cast<uint8_t *>(&background) +
                                                  sizeof(BackgroundComponent));
        message.body.insert(message.body.end(), backgroundBytes.begin(), backgroundBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createScrollMsg(float x, float y)
    {
        ...
        message.body.insert(message.body.end(), scrollBytes.begin(), scrollBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> createParentMsg(uint32_t parentID)
    {
        ...
        message.body.insert(message.body.end(), parentBytes.begin(), parentBytes.end());
        std::chrono::system_clock::time_point timeNow = std::chrono::system_clock::now();
        message << timeNow;
        return message;
    }
    rtype::network::Message<NetworkMessages> updateTextureMsg(std::string texturePath)
    {
        rtype::network::Message<NetworkMessages> message;
    ...
    rtype::network::Message<NetworkMessages> updateMusicMsg(std::string musicPath)
    {
        rtype::network::Message<NetworkMessages> message;
    ...
    rtype::network::Message<NetworkMessages> updateSoundMsg(std::string soundPath)
    {
        rtype::network::Message<NetworkMessages> message;
    ...
    rtype::network::Message<NetworkMessages> updateTransformMsg(float x, float y, float scaleX, float scaleY)
    {
        rtype::network::Message<NetworkMessages> message;
    ...
    rtype::network::Message<NetworkMessages> updateBackgroundMsg(std::string texturePath, float x, float y)
    {
        rtype::network::Message<NetworkMessages> message;

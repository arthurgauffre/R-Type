...
public:
  ...
  ASIO_DECL void register_internal_io_object(io_object *&io_obj, int op_type,
  ...
  ASIO_DECL void cancel_ops_by_key(per_io_object_data &io_obj, int op_type,
...
private:
  ...
  ASIO_DECL bool do_cancel_ops(per_io_object_data &io_obj,

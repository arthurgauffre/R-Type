...
public:
  ...
  winrt_resolver_service(execution_context &context)
      : execution_context_service_base<winrt_resolver_service<Protocol>>(
            context),
  ...
  void move_assign(implementation_type &, winrt_resolver_service &,
                   implementation_type &) {}
  ...
  results_type resolve(implementation_type &, const query_type &query,
    ...
    try {
      ...
      auto endpoint_pairs =
          async_manager_.sync(DatagramSocket::GetEndpointPairsAsync(
      ...
      return results_type::create(endpoint_pairs, query.hints(),
  ...
  void async_resolve(implementation_type &impl, const query_type &query,
    ...
    ASIO_HANDLER_CREATION(
        (scheduler_.context(), *p.p, "resolver", &impl, 0, "async_resolve"));
    (void)impl;
  ...
  results_type resolve(implementation_type &, const endpoint_type &,
                       asio::error_code &ec) {

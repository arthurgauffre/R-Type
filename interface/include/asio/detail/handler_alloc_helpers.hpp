...
inline void *default_allocate(std::size_t s,
  ...
  return asio::detail::thread_info_base::allocate(
      asio::detail::thread_context::top_of_thread_call_stack(), s, align);
...
public:
  ...
  template <typename U> struct rebind { typedef default_allocator<U> other; };
    ...
    void reset() {                                                             \
      ...
      if (v) {                                                                 \
        ...
        typedef typename ::asio::detail::get_default_allocator<                \
            associated_allocator_type>::type default_allocator_type;           \
        ASIO_REBIND_ALLOC(default_allocator_type, op)                          \
        a(::asio::detail::get_default_allocator<associated_allocator_type>::   \
              get(::asio::get_associated_allocator(*h)));                      \

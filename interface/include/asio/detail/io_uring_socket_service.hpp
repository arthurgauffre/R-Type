...
public:
  ...
  io_uring_socket_service(execution_context &context)
      : execution_context_service_base<io_uring_socket_service<Protocol>>(
            context),
  ...
  void converting_move_construct(
      implementation_type &impl, io_uring_socket_service<Protocol1> &,
      typename io_uring_socket_service<Protocol1>::implementation_type
          &other_impl) {
    this->base_move_construct(impl, other_impl);
  ...
  endpoint_type remote_endpoint(const implementation_type &impl,
    ...
    endpoint_type endpoint;
    std::size_t addr_len = endpoint.capacity();
    if (socket_ops::getpeername(impl.socket_, endpoint.data(), &addr_len, false,
                                ec)) {
      ASIO_ERROR_LOCATION(ec);
      return endpoint_type();
    }
  ...
  size_t send_to(implementation_type &impl, const ConstBufferSequence &buffers,
    ...
    if (bufs_type::is_single_buffer) {
      ...
      n = socket_ops::sync_sendto(impl.socket_, impl.state_, bufs.buffers(),
                                  bufs.count(), flags, destination.data(),
                                  destination.size(), ec);
    }
  ...
  void async_send_to(implementation_type &impl,
    ...
    typedef io_uring_socket_sendto_op<ConstBufferSequence, endpoint_type,
                                      Handler, IoExecutor>
        op;
    typename op::ptr p = {asio::detail::addressof(handler),
                          op::ptr::allocate(handler), 0};
    p.p = new (p.v) op(success_ec_, impl.socket_, impl.state_, buffers,
    ...
    ASIO_HANDLER_CREATION((io_uring_service_.context(), *p.p, "socket", &impl,
  ...
  void async_send_to(implementation_type &impl, const null_buffers &,
    ...
    ASIO_HANDLER_CREATION((io_uring_service_.context(), *p.p, "socket", &impl,
                           impl.socket_, "async_send_to(null_buffers)"));
  ...
  size_t receive_from(implementation_type &impl,
    ...
    if (bufs_type::is_single_buffer) {
      ...
      n = socket_ops::sync_recvfrom(impl.socket_, impl.state_, bufs.buffers(),
                                    bufs.count(), flags, sender_endpoint.data(),
                                    &addr_len, ec);
    }
  ...
  void async_receive_from(implementation_type &impl,
    ...
    // Allocate and construct an operation to wrap the handler.
    typedef io_uring_socket_recvfrom_op<MutableBufferSequence, endpoint_type,
                                        Handler, IoExecutor>
        op;
    typename op::ptr p = {asio::detail::addressof(handler),
                          op::ptr::allocate(handler), 0};
  ...
  void async_receive_from(implementation_type &impl, const null_buffers &,
    ...
    ASIO_HANDLER_CREATION((io_uring_service_.context(), *p.p, "socket", &impl,
                           impl.socket_, "async_receive_from(null_buffers)"));
  ...
  asio::error_code accept(implementation_type &impl, Socket &peer,
    ...
    socket_holder new_socket(socket_ops::sync_accept(
        impl.socket_, impl.state_, peer_endpoint ? peer_endpoint->data() : 0,
  ...
  void async_move_accept(implementation_type &impl,
    ...
    // Allocate and construct an operation to wrap the handler.
    typedef io_uring_socket_move_accept_op<Protocol, PeerIoExecutor, Handler,
                                           IoExecutor>
        op;
    typename op::ptr p = {asio::detail::addressof(handler),
                          op::ptr::allocate(handler), 0};
  ...
  void async_connect(implementation_type &impl,
    ...
    typename op::ptr p = {asio::detail::addressof(handler),
                          op::ptr::allocate(handler), 0};
    p.p =
        new (p.v) op(success_ec_, impl.socket_, peer_endpoint, handler, io_ex);

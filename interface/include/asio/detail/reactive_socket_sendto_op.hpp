...
public:
  reactive_socket_sendto_op_base(const asio::error_code &success_ec,
      ...
      : reactor_op(success_ec, &reactive_socket_sendto_op_base::do_perform,
                   complete_func),
        socket_(socket), buffers_(buffers), destination_(endpoint),
        flags_(flags) {}
  ...
  static status do_perform(reactor_op *base) {
    ...
    if (bufs_type::is_single_buffer) {
      ...
      result = socket_ops::non_blocking_sendto(

...
public:
  io_uring_socket_accept_op_base(const asio::error_code &success_ec,
      ...
      : io_uring_operation(
            success_ec, &io_uring_socket_accept_op_base::do_prepare,
  ...
  static bool do_perform(io_uring_operation *base, bool after_completion) {
    ...
    if ((o->state_ & socket_ops::internal_non_blocking) != 0) {
      ...
      bool result = socket_ops::non_blocking_accept(
          o->socket_, o->state_,
          o->peer_endpoint_ ? o->peer_endpoint_->data() : 0,
...
public:
  ...
  static void do_complete(void *owner, operation *base,
    ...
    ASIO_ASSUME(base != 0);
    io_uring_socket_accept_op *o(
        static_cast<io_uring_socket_accept_op *>(base));
...
public:
  ...
  static void do_complete(void *owner, operation *base,
    ...
    detail::move_binder2<Handler, asio::error_code, peer_socket_type> handler(
        0, static_cast<Handler &&>(o->handler_), o->ec_,

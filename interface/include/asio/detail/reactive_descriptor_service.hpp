...
public:
  ...
  void async_wait(implementation_type &impl,
    ...
    ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor", &impl,
                           impl.descriptor_, "async_wait"));
  ...
  void async_write_some(implementation_type &impl,
    ...
    ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor", &impl,
                           impl.descriptor_, "async_write_some"));
  ...
  void async_write_some(implementation_type &impl, const null_buffers &,
    ...
    ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor", &impl,
                           impl.descriptor_, "async_write_some(null_buffers)"));
  ...
  void async_read_some(implementation_type &impl,
    ...
    ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor", &impl,
                           impl.descriptor_, "async_read_some"));
  ...
  void async_read_some(implementation_type &impl, const null_buffers &,
    ...
    ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "descriptor", &impl,
                           impl.descriptor_, "async_read_some(null_buffers)"));

    start_op(impl, reactor::read_op, p.p, is_continuation, false, false, &io_ex,
             0);
    p.v = p.p = 0;
  }
...
private:
  ...
  ASIO_DECL void
  do_start_op(implementation_type &impl, int op_type, reactor_op *op,
  ...
  template <typename Op>
  void
  start_op(implementation_type &impl, int op_type, Op *op, bool is_continuation,
           bool is_non_blocking, bool noop, const void *,
           enable_if_t<is_same<
  ...
  public:
    reactor_op_cancellation(reactor *r, reactor::per_descriptor_data *p, int d,
                            int o)

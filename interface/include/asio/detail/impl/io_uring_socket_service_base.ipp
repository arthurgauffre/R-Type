...
void io_uring_socket_service_base::destroy(
  ...
  if (impl.socket_ != invalid_socket) {
    ASIO_HANDLER_OPERATION(
        (io_uring_service_.context(), "socket", &impl, impl.socket_, "close"));
...
socket_type io_uring_socket_service_base::release(
  ...
  ASIO_HANDLER_OPERATION(
      (io_uring_service_.context(), "socket", &impl, impl.socket_, "release"));
...
asio::error_code io_uring_socket_service_base::cancel(
  ...
  ASIO_HANDLER_OPERATION(
      (io_uring_service_.context(), "socket", &impl, impl.socket_, "cancel"));
...
asio::error_code io_uring_socket_service_base::do_open(
    io_uring_socket_service_base::base_implementation_type &impl, int af,
...
void io_uring_socket_service_base::start_op(
    io_uring_socket_service_base::base_implementation_type &impl, int op_type,

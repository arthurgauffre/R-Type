...
public:
  ...
  allocator_binder(F &&f, const Allocator &a)
      : f_(static_cast<F &&>(f)), allocator_(a) {}
...
class strand_executor_service::invoker<
    Executor, enable_if_t<execution::is_executor<Executor>::value>> {
public:
  ...
  invoker(const invoker &other)
      : impl_(other.impl_), executor_(other.executor_) {}
  ...
  struct on_invoker_exit {
    ...
    ~on_invoker_exit() {
      if (push_waiting_to_ready(this_->impl_)) {
        ...
        asio::prefer(asio::require(static_cast<executor_type &&>(ex),
...
inline void strand_executor_service::execute(
  ...
  return strand_executor_service::do_execute(
      impl, ex, static_cast<Function &&>(function),
...
inline void strand_executor_service::execute(
    ...
    enable_if_t<!can_query<Executor, execution::allocator_t<void>>::value> *) {
  return strand_executor_service::do_execute(
      impl, ex, static_cast<Function &&>(function), std::allocator<void>());
}
...
void strand_executor_service::do_execute(const implementation_type &impl,
  ...
  ASIO_HANDLER_CREATION((impl->service_->context(), *p.p, "strand_executor",
                         impl.get(), 0, "execute"));
...
void strand_executor_service::dispatch(const implementation_type &impl,
  ...
  p.v = p.p = 0;
  if (first) {
    asio::dispatch(ex, allocator_binder<invoker<Executor>, Allocator>(
...
void strand_executor_service::post(const implementation_type &impl,
  ...
  p.v = p.p = 0;
  if (first) {
    asio::post(ex, allocator_binder<invoker<Executor>, Allocator>(
                       invoker<Executor>(impl, ex), a));
  }
}
...
void strand_executor_service::defer(const implementation_type &impl,
  ...
  p.v = p.p = 0;
  if (first) {
    asio::defer(ex, allocator_binder<invoker<Executor>, Allocator>(
                        invoker<Executor>(impl, ex), a));
  }
}

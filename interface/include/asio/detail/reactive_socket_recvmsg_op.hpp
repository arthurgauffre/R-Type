...
public:
  reactive_socket_recvmsg_op_base(const asio::error_code &success_ec,
      ...
      : reactor_op(success_ec, &reactive_socket_recvmsg_op_base::do_perform,
                   complete_func),
        socket_(socket), buffers_(buffers), in_flags_(in_flags),
  ...
  static status do_perform(reactor_op *base) {
    ...
    status result = socket_ops::non_blocking_recvmsg(
                        o->socket_, bufs.buffers(), bufs.count(), o->in_flags_,

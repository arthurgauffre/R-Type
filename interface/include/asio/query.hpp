...
struct call_traits<
    ...
    enable_if_t<is_applicable_property<decay_t<T>, decay_t<Property>>::value>,
    enable_if_t<!static_query<T, Property>::is_valid>,
    enable_if_t<query_member<typename Impl::template proxy<T>::type,
                             Property>::is_valid>>
...
static constexpr const asio_query_fn::impl &query =
    asio_query_fn::static_instance<>::instance;
...
template <typename T, typename Property>
struct can_query
    : integral_constant<bool, asio_query_fn::call_traits<
...
template <typename T, typename Property> struct query_result {
  typedef typename asio_query_fn::call_traits<query_t, T,

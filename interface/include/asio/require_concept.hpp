...
struct call_traits<
    ...
    enable_if_t<decay_t<Property>::is_requirable_concept>,
    enable_if_t<!static_require_concept<T, Property>::is_valid>,
    enable_if_t<require_concept_member<typename Impl::template proxy<T>::type,
                                       Property>::is_valid>>
...
struct call_traits<
    ...
    enable_if_t<!require_concept_member<typename Impl::template proxy<T>::type,
                                        Property>::is_valid>,
    enable_if_t<require_concept_free<T, Property>::is_valid>>
  ...
  template <typename T> struct proxy {
    ...
    struct type {
      ...
      auto require_concept(P &&p) noexcept(
          noexcept(declval<conditional_t<true, T, P>>().require_concept(
              static_cast<P &&>(p))))
          -> decltype(declval<conditional_t<true, T, P>>().require_concept(
              static_cast<P &&>(p)));
    };
...
struct is_nothrow_require_concept
    : integral_constant<
          bool, asio_require_concept_fn::call_traits<

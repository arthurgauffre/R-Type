...
struct blocking_t {
  ...
  friend constexpr bool operator==(const blocking_t &a,
...
template <int I = 0> struct blocking_t {
  ...
  template <typename T>
  static constexpr typename traits::static_query<T, possibly_t>::result_type
  static_query(enable_if_t<!query_static_constexpr_member<T>::is_valid> * = 0,
               enable_if_t<!query_member<T>::is_valid> * = 0,
               enable_if_t<traits::static_query<T, possibly_t>::is_valid> * =
                   0) noexcept {
    return traits::static_query<T, possibly_t>::value();
  }

  template <typename T>
  static constexpr typename traits::static_query<T, always_t>::result_type
  static_query(
  ...
  template <typename T>
  static constexpr typename traits::static_query<T, never_t>::result_type
  static_query(
      enable_if_t<!query_static_constexpr_member<T>::is_valid> * = 0,
      enable_if_t<!query_member<T>::is_valid> * = 0,
      enable_if_t<!traits::static_query<T, possibly_t>::is_valid> * = 0,
  ...
  friend constexpr blocking_t
  query(const Executor &ex, convertible_from_blocking_t,
...
public:
  ...
  template <int I>
  enable_if_t<can_require<const Executor &, possibly_t<I>>::value,
  ...
  template <int I>
  enable_if_t<can_require<const Executor &, never_t<I>>::value,
  ...
  execute(Function &&f) const {
    blocking_adaptation::blocking_execute(executor_,
...
template <int I = 0> struct always_t {
  ...
  friend adapter<Executor> require(
      ...
      enable_if_t<traits::static_require<
          const Executor &, blocking_adaptation::allowed_t<0>>::is_valid> * =
          0) {
...
struct static_query<T, execution::blocking_t,
                    enable_if_t<execution::detail::blocking_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::blocking_t<
...
struct static_query<
    T, execution::blocking_t,
    enable_if_t<
        !execution::detail::blocking_t<0>::query_static_constexpr_member<
            T>::is_valid &&
  ...
  typedef typename traits::static_query<
      T, execution::blocking_t::possibly_t>::result_type result_type;
...
struct static_query<
  ...
  typedef typename traits::static_query<
      T, execution::blocking_t::always_t>::result_type result_type;
...
struct static_query<
  ...
  typedef typename traits::static_query<
      T, execution::blocking_t::never_t>::result_type result_type;
...
struct static_query<T, execution::blocking_t::possibly_t,
                    enable_if_t<execution::detail::blocking::possibly_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::blocking::possibly_t<
      0>::query_static_constexpr_member<T>::result_type result_type;

  static constexpr result_type value() {
    return execution::detail::blocking::possibly_t<
...
struct static_query<
    ...
    enable_if_t<
        !execution::detail::blocking::possibly_t<
            0>::query_static_constexpr_member<T>::is_valid &&
        !execution::detail::blocking::possibly_t<0>::query_member<
            T>::is_valid &&
...
struct static_query<T, execution::blocking_t::always_t,
                    enable_if_t<execution::detail::blocking::always_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::blocking::always_t<
      0>::query_static_constexpr_member<T>::result_type result_type;

  static constexpr result_type value() {
    return execution::detail::blocking::always_t<
        0>::query_static_constexpr_member<T>::value();
  }
};
...
struct static_query<T, execution::blocking_t::never_t,
                    enable_if_t<execution::detail::blocking::never_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::blocking::never_t<
      0>::query_static_constexpr_member<T>::result_type result_type;

  static constexpr result_type value() {
    return execution::detail::blocking::never_t<
        0>::query_static_constexpr_member<T>::value();
  }
};
...
struct require_free_default<
    ...
    enable_if_t<
        is_same<T, decay_t<T>>::value && execution::is_executor<T>::value &&
        traits::static_require<
            const T &,
            execution::detail::blocking_adaptation::allowed_t<0>>::is_valid>> {
  static constexpr bool is_valid = true;
...
template <typename Executor, typename Function>
struct execute_member<execution::detail::blocking::adapter<Executor>,
                      Function> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    execution::detail::blocking::adapter<Executor>,
    execution::detail::blocking::possibly_t<I>,
    enable_if_t<can_require<
        const Executor &, execution::detail::blocking::possibly_t<I>>::value>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept =
...
struct require_member<
    execution::detail::blocking::adapter<Executor>,
    execution::detail::blocking::never_t<I>,
    enable_if_t<can_require<const Executor &,

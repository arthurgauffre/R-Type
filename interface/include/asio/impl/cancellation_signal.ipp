...
cancellation_signal::~cancellation_signal() {
  if (handler_) {
    ...
    detail::thread_info_base::deallocate(
        ...
        detail::thread_context::top_of_thread_call_stack(), mem.first,
        mem.second);
  }
}
...
cancellation_slot::prepare_memory(std::size_t size, std::size_t align) {
  assert(handler_);

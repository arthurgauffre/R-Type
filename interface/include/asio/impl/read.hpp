...
std::size_t read_buffer_seq(SyncReadStream &s,
                            ...
                            asio::error_code &ec) {
  ec = asio::error_code();
  asio::detail::consuming_buffers<mutable_buffer, MutableBufferSequence,
...
std::size_t
read(SyncReadStream &s, const MutableBufferSequence &buffers,
...
read(SyncReadStream &s, DynamicBuffer_v1 &&buffers,
  ...
  asio::error_code ec;
  std::size_t bytes_transferred =
      read(s, static_cast<DynamicBuffer_v1 &&>(buffers), transfer_all(), ec);
  asio::detail::throw_error(ec, "read");
  return bytes_transferred;
}
...
read(SyncReadStream &s, DynamicBuffer_v1 &&buffers,
  ...
  asio::error_code ec;
  std::size_t bytes_transferred =
      read(s, static_cast<DynamicBuffer_v1 &&>(buffers),
           static_cast<CompletionCondition &&>(completion_condition), ec);
  asio::detail::throw_error(ec, "read");
  return bytes_transferred;
}
...
std::size_t read(SyncReadStream &s, DynamicBuffer_v2 buffers,
  ...
  while (bytes_available > 0) {
    ...
    std::size_t bytes_transferred =
        s.read_some(b.data(pos, bytes_available), ec);
...
read(SyncReadStream &s, DynamicBuffer_v2 buffers,
  ...
  asio::error_code ec;
  std::size_t bytes_transferred =
      read(s, static_cast<DynamicBuffer_v2 &&>(buffers), transfer_all(), ec);
  asio::detail::throw_error(ec, "read");
  return bytes_transferred;
}
...
read(SyncReadStream &s, DynamicBuffer_v2 buffers,
  ...
  asio::error_code ec;
  std::size_t bytes_transferred =
      read(s, static_cast<DynamicBuffer_v2 &&>(buffers),
           static_cast<CompletionCondition &&>(completion_condition), ec);
  asio::detail::throw_error(ec, "read");
  return bytes_transferred;
}
...
class read_op : public base_from_cancellation_state<ReadHandler>,
...
template <typename AsyncReadStream, typename MutableBufferSequence,
          ...
          typename ReadHandler>
inline void
start_read_op(AsyncReadStream &stream, const MutableBufferSequence &buffers,
              const MutableBufferIterator &,
              CompletionCondition &completion_condition, ReadHandler &handler) {
  read_op<AsyncReadStream, MutableBufferSequence, MutableBufferIterator,
...
public:
  ...
  void operator()(ReadHandler &&handler, const MutableBufferSequence &buffers,
    ...
    start_read_op(stream_, buffers, asio::buffer_sequence_begin(buffers),
...
struct associator<
  ...
  get(const detail::read_op<AsyncReadStream, MutableBufferSequence,
                            MutableBufferIterator, CompletionCondition,
                            ReadHandler> &h) noexcept {
    return Associator<ReadHandler, DefaultCandidate>::get(h.handler_);
  }

  static auto get(const detail::read_op<AsyncReadStream, MutableBufferSequence,
                                        MutableBufferIterator,
...
template <typename AsyncReadStream, typename MutableBufferSequence,
          ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code, std::size_t))
              ReadToken>
inline auto async_read(
    AsyncReadStream &s, const MutableBufferSequence &buffers, ReadToken &&token,
    constraint_t<is_mutable_buffer_sequence<MutableBufferSequence>::value>)
    -> decltype(async_initiate<ReadToken, void(asio::error_code, std::size_t)>(
        declval<detail::initiate_async_read<AsyncReadStream>>(), token, buffers,
        transfer_all())) {
...
public:
  ...
  read_dynbuf_v1_op(AsyncReadStream &stream, BufferSequence &&buffers,
                    CompletionCondition &completion_condition,
                    ReadHandler &handler)
      : base_from_cancellation_state<ReadHandler>(
            handler, enable_partial_cancellation()),
  ...
  read_dynbuf_v1_op(read_dynbuf_v1_op &&other)
      : base_from_cancellation_state<ReadHandler>(
        ...
        start_(other.start_), total_transferred_(other.total_transferred_),
        handler_(static_cast<ReadHandler &&>(other.handler_)) {}
...
template <typename AsyncReadStream, typename DynamicBuffer_v1,
          typename CompletionCondition, typename ReadHandler>
inline bool asio_handler_is_continuation(
    read_dynbuf_v1_op<AsyncReadStream, DynamicBuffer_v1, CompletionCondition,
...
struct associator<Associator,
                  detail::read_dynbuf_v1_op<AsyncReadStream, DynamicBuffer_v1,
                                            CompletionCondition, ReadHandler>,
                  DefaultCandidate>
...
template <typename AsyncReadStream, typename DynamicBuffer_v1,
          ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code, std::size_t))
              ReadToken>
inline auto async_read(
    AsyncReadStream &s, DynamicBuffer_v1 &&buffers, ReadToken &&token,
    constraint_t<is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value>,
    constraint_t<!is_dynamic_buffer_v2<decay_t<DynamicBuffer_v1>>::value>)
    -> decltype(async_initiate<ReadToken, void(asio::error_code, std::size_t)>(
  ...
  return async_initiate<ReadToken, void(asio::error_code, std::size_t)>(
      detail::initiate_async_read_dynbuf_v1<AsyncReadStream>(s), token,
...
public:
  template <typename BufferSequence>
  read_dynbuf_v2_op(AsyncReadStream &stream, BufferSequence &&buffers,
                    CompletionCondition &completion_condition,
                    ReadHandler &handler)
      : base_from_cancellation_state<ReadHandler>(
            handler, enable_partial_cancellation()),
        base_from_completion_cond<CompletionCondition>(completion_condition),
        stream_(stream), buffers_(static_cast<BufferSequence &&>(buffers)),
        start_(0), total_transferred_(0), bytes_available_(0),
        handler_(static_cast<ReadHandler &&>(handler)) {}
  ...
  read_dynbuf_v2_op(const read_dynbuf_v2_op &other)
      : base_from_cancellation_state<ReadHandler>(other),
        ...
        bytes_available_(other.bytes_available_), handler_(other.handler_) {}
...
template <typename AsyncReadStream, typename DynamicBuffer_v2,
          typename CompletionCondition, typename ReadHandler>
inline bool asio_handler_is_continuation(
    read_dynbuf_v2_op<AsyncReadStream, DynamicBuffer_v2, CompletionCondition,
                      ReadHandler> *this_handler) {
  return this_handler->start_ == 0 ? true
                                   : asio_handler_cont_helpers::is_continuation(
                                         this_handler->handler_);
...
template <template <typename, typename> class Associator,
          ...
          typename DefaultCandidate>
struct associator<Associator,
                  detail::read_dynbuf_v2_op<AsyncReadStream, DynamicBuffer_v2,
                                            CompletionCondition, ReadHandler>,
                  DefaultCandidate>
    : Associator<ReadHandler, DefaultCandidate> {
  static typename Associator<ReadHandler, DefaultCandidate>::type
...
template <typename AsyncReadStream, typename DynamicBuffer_v2,
          ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code, std::size_t))
              ReadToken>
inline auto
async_read(AsyncReadStream &s, DynamicBuffer_v2 buffers, ReadToken &&token,
           constraint_t<is_dynamic_buffer_v2<DynamicBuffer_v2>::value>)
    -> decltype(async_initiate<ReadToken, void(asio::error_code, std::size_t)>(
        declval<detail::initiate_async_read_dynbuf_v2<AsyncReadStream>>(),
        token, static_cast<DynamicBuffer_v2 &&>(buffers), transfer_all())) {
  return async_initiate<ReadToken, void(asio::error_code, std::size_t)>(
      detail::initiate_async_read_dynbuf_v2<AsyncReadStream>(s), token,

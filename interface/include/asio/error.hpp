...
enum basic_errors {
  ...
  operation_aborted = ASIO_WIN_OR_POSIX(
      ASIO_NATIVE_ERROR(ERROR_OPERATION_ABORTED), ASIO_NATIVE_ERROR(ECANCELED)),
...
#if !defined(ASIO_ERROR_LOCATION) && !defined(ASIO_DISABLE_ERROR_LOCATION) &&  \
    defined(ASIO_HAS_BOOST_CONFIG) && (BOOST_VERSION >= 107900)

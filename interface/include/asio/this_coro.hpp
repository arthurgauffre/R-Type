...
template <typename Filter>
ASIO_NODISCARD inline constexpr reset_cancellation_state_1_t<decay_t<Filter>>
...
template <typename InFilter, typename OutFilter>
ASIO_NODISCARD inline constexpr reset_cancellation_state_2_t<decay_t<InFilter>,
                                                             decay_t<OutFilter>>
reset_cancellation_state(InFilter &&in_filter, OutFilter &&out_filter) {

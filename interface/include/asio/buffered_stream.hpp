...
public:
  ...
  auto async_flush(
      ...
      -> decltype(declval<buffered_write_stream<Stream> &>().async_flush(
  ...
  auto async_write_some(
      ...
      WriteHandler &&handler = default_completion_token_t<executor_type>())
      -> decltype(declval<Stream &>().async_write_some(
  ...
  auto async_fill(
      ...
      -> decltype(declval<
                      buffered_read_stream<buffered_write_stream<Stream>> &>()
                      .async_fill(static_cast<ReadHandler &&>(handler))) {
  ...
  auto async_read_some(
      ...
      ReadHandler &&handler = default_completion_token_t<executor_type>())
      -> decltype(declval<Stream &>().async_read_some(

...
protected:
  ...
  channel_operation(func_type func)
      : next_(0), func_(func), cancellation_key_(0) {}
...
public:
  ...
  void dispatch(Function &function, Handler &handler) {
    ...
    asio::prefer(executor_, execution::allocator(allocator))
...
public:
  ...
  void post(const IoExecutor &, Function &function, Handler &handler) {
    ...
    asio::prefer(asio::require(executor_, execution::blocking.never),
...
public:
  ...
  void dispatch(Function &function, Handler &handler) {
    ...
    work_.get_executor().dispatch(static_cast<Function &&>(function),
                                  allocator);
  }
...
public:
  ...
  template <typename Function>
  void
  immediate(Function &function, Handler &,
            enable_if_t<
                is_same<typename associated_immediate_executor<
    ...
    (asio::detail::initiate_post_with_executor<
        typename base1_type::executor_type>(base1_type::get_executor()))(
        static_cast<Function &&>(function));
  }
};
...
public:
  ...
  template <typename Function>
  void
  immediate(Function &function, Handler &handler,
            enable_if_t<
                is_same<typename associated_immediate_executor<
                            conditional_t<false, Function, Handler>,
                            typename base1_type::executor_type>::

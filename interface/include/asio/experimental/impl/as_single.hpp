...
inline bool
asio_handler_is_continuation(as_single_handler<Handler> *this_handler) {
...
template <typename R> struct as_single_signature<R()> { typedef R type(); };
...
struct async_result<experimental::as_single_t<CompletionToken>, Signature> {
  ...
  static auto initiate(Initiation &&initiation, RawCompletionToken &&token,
      ...
      -> decltype(async_initiate<CompletionToken,
                                 typename experimental::detail::
                                     as_single_signature<Signature>::type>(
...
struct associator<Associator, experimental::detail::as_single_handler<Handler>,
                  DefaultCandidate> : Associator<Handler, DefaultCandidate> {
  static typename Associator<Handler, DefaultCandidate>::type
  get(const experimental::detail::as_single_handler<Handler> &h) noexcept {

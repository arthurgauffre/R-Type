...
class basic_concurrent_channel
    ...
    : public detail::channel_send_functions<
          basic_concurrent_channel<Executor, Traits, Signatures...>, Executor,
          Signatures...>
...
public:
  ...
  basic_concurrent_channel(
      ExecutionContext &context, std::size_t max_buffer_size = 0,
      constraint_t<
...
private:
  ...
  basic_concurrent_channel &
  operator=(const basic_concurrent_channel &) = delete;

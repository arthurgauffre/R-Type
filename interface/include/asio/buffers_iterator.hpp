...
template <> struct buffers_iterator_types_helper<true> {
  ...
  template <typename ByteType> struct byte_type { typedef ByteType type; };
};
...
private:
  ...
  typedef typename detail::buffers_iterator_types<
      BufferSequence, ByteType>::const_iterator buffer_sequence_iterator_type;
...
public:
  ...
  buffers_iterator()
      : current_buffer_(), current_buffer_position_(0), begin_(), current_(),
        end_(), position_(0) {}

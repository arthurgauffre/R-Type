...
address::address() noexcept : type_(ipv4), ipv4_address_(), ipv6_address_() {}

address::address(const asio::ip::address_v4 &ipv4_address) noexcept
    : type_(ipv4), ipv4_address_(ipv4_address), ipv6_address_() {}

address::address(const asio::ip::address_v6 &ipv6_address) noexcept
    : type_(ipv6), ipv4_address_(), ipv6_address_(ipv6_address) {}

address::address(const address &other) noexcept
    : type_(other.type_), ipv4_address_(other.ipv4_address_),
...
address &address::operator=(const asio::ip::address_v4 &ipv4_address) noexcept {
  type_ = ipv4;
...
address &address::operator=(const asio::ip::address_v6 &ipv6_address) noexcept {
  type_ = ipv6;
...
address make_address(const char *str, asio::error_code &ec) noexcept {
  asio::ip::address_v6 ipv6_address = asio::ip::make_address_v6(str, ec);
  if (!ec)
    return address(ipv6_address);

  asio::ip::address_v4 ipv4_address = asio::ip::make_address_v4(str, ec);
  if (!ec)
...
address make_address(const std::string &str, asio::error_code &ec) noexcept {
...
address make_address(string_view str, asio::error_code &ec) noexcept {

...
network_v4::network_v4(const address_v4 &addr, const address_v4 &mask)
    : address_(addr), prefix_length_(0) {
...
address_v4_range network_v4::hosts() const noexcept {
  return is_host()
             ...
             : address_v4_range(address_v4(network().to_uint() + 1),
                                broadcast());
}
...
network_v4 make_network_v4(const std::string &str, asio::error_code &ec) {
...
network_v4 make_network_v4(string_view str, asio::error_code &ec) {

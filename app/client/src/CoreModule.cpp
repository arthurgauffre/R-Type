 ...
 */
entity::IEntity *
rtype::CoreModule::createBackground(std::string texturePath,
                                    std::pair<float, float> speed,
                                    std::pair<float, float> size) {
  entity::IEntity *background1 = this->getEntityManager()->createEntity(
      this->getEntityManager()->generateEntityID());

  entity::IEntity *background2 = this->getEntityManager()->createEntity(
      this->getEntityManager()->generateEntityID());

  this->getComponentManager()->addComponent<component::TypeComponent>(
      background1->getID(), "background");
  ...
  this->getComponentManager()->addComponent<component::SizeComponent>(
      background1->getID(), size);

  this->getComponentManager()->addComponent<component::TypeComponent>(
      background2->getID(), "background");
  this->getComponentManager()->addComponent<component::TransformComponent>(

...
void rtype::CoreModule::init()
{
    ...
    this->createEnemy(this->getEntityManager()->generateEntityID(),
                      "app/assets/sprites/enemy.png", sf::Vector2f(1800.0f, 0.0f),
                      sf::Vector2f(0.0f, 0.0f), sf::Vector2f(0.2f, 0.2f), 1, 100);

    this->createEnemy(this->getEntityManager()->generateEntityID(),
                      "app/assets/sprites/enemy.png",
                      sf::Vector2f(1800.0f, 200.0f), sf::Vector2f(0.0f, 0.0f),
                      sf::Vector2f(0.2f, 0.2f), 1, 100);

    this->createEnemy(this->getEntityManager()->generateEntityID(),
                      "app/assets/sprites/enemy.png",
                      sf::Vector2f(1800.0f, 400.0f), sf::Vector2f(0.0f, 0.0f),
                      sf::Vector2f(0.2f, 0.2f), 1, 100);

    this->createEnemy(this->getEntityManager()->generateEntityID(),
                      "app/assets/sprites/enemy.png",
                      sf::Vector2f(1800.0f, 600.0f), sf::Vector2f(0.0f, 0.0f),
                      sf::Vector2f(0.2f, 0.2f), 1, 100);

    this->createEnemy(this->getEntityManager()->generateEntityID(),
                      "app/assets/sprites/enemy.png",
                      sf::Vector2f(1800.0f, 800.0f), sf::Vector2f(0.0f, 0.0f),
                      sf::Vector2f(0.2f, 0.2f), 1, 100);

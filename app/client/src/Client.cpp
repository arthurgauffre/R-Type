...
namespace rtype
{
  namespace network
  {
    ...
    void Client::handdleMessage(rtype::network::Message<NetworkMessages> &msg)
    {
      ...
      //   _coreModule.get()->getComponentManager()->addComponent<component::SoundComponent>(id.id, sound.soundPath);
      // }
      // break;
      ...
      case NetworkMessages::updateSprite:
      {
        ...
        _coreModule.get()
            ->getComponentManager()
            ->updateComponent<component::SpriteComponent>(id.id, sprite.x, sprite.y);
      }
      break;
      ...
      case NetworkMessages::updateHitbox:
      {
        ...
        _coreModule.get()
            ->getComponentManager()
            ->updateComponent<component::HitBoxComponent>(id.id, hitbox.x, hitbox.y);
      }
      // break;
        ...
        //               sizeof(SoundComponent));
        //   std::cout << "Sound: " << sound.soundPath << std::endl;
        //   _coreModule.get()->getComponentManager()->updateComponent<component::SoundComponent>(id.id, sound.soundPath);
        // }
        // break;
      }
    }

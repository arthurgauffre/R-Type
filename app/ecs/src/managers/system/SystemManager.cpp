 ...
 */
void ECS_system::SystemManager::addSystem(component::ComponentManager &componentManager, std::string systemName)
{
  if (systemName == "RenderSystem")
  {
    ...
    std::shared_ptr<ECS_system::ISystem> renderSystem = renderSystemLoader->getInstance("createRenderSystem", componentManager);
  ...
  else if (systemName == "AudioSystem")
  {
    ...
    std::shared_ptr<ECS_system::ISystem> audioSystem = audioSystemLoader->getInstance("createAudioSystem", componentManager);

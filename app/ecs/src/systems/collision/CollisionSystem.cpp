    ...
    component::HitBoxComponent *hitbox1, component::HitBoxComponent *hitbox2)
{
  ...
  if (pos1->getPosition().first < pos2->getPosition().first + hitbox2->getWidth() &&
      pos1->getPosition().first + hitbox1->getWidth() > pos2->getPosition().first &&
      pos1->getPosition().second < pos2->getPosition().second + hitbox2->getHeight() &&
      pos1->getPosition().second + hitbox1->getHeight() > pos2->getPosition().second)
    return true;
  return false;
}

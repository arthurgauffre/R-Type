...
{
    entity::IEntity *projectile = this->_entityManager.createEntity(_entityManager.generateEntityID());
    ...
    sf::Vector2f position = {this->_componentManager.getComponent<component::PositionComponent>(parentID)->getX(),
                             this->_componentManager.getComponent<component::PositionComponent>(parentID)->getY()};

                                                ...
                                                int damage)
{
    ...
    sf::Vector2f position = {_componentManager.getComponent<component::PositionComponent>(parentID)->getX() + _componentManager.getComponent<component::SpriteComponent>(parentID)->getSprite().getTexture()->getSize().x,
                             _componentManager.getComponent<component::PositionComponent>(parentID)->getY() + _componentManager.getComponent<component::SpriteComponent>(parentID)->getSprite().getTexture()->getSize().y / 2};
    ...
    this->_componentManager.addComponent<component::SpriteComponent>(
        projectile->getID(), _componentManager.getComponent<component::PositionComponent>(parentID)->getX(), _componentManager.getComponent<component::PositionComponent>(parentID)->getY());
}
    ...
    float deltaTime, std::vector<std::shared_ptr<entity::IEntity>> entities)
{
             ...
             entities))
    {
        ...
        if (weaponComponent->getIsFiring() == true)
        {
            this->createProjectile(weaponComponent->getEntityID(), "app/assets/sprites/projectile.gif", sf::Vector2f(200, 0), sf::Vector2f(1, 1), 10);

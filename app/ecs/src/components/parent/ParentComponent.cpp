 ...
 */
component::ParentComponent::ParentComponent(uint32_t entityID, uint32_t parentID) : AComponent(entityID), _parentID(parentID)
{
}
 ...
 * 
 * This function returns the ID of the parent component associated with this instance.
 * 

 ...
 */
component::SizeComponent::SizeComponent(uint32_t entityID, std::pair<float, float> size)
 ...
 *
 * This function returns the size of the component as a pair representing the width and height.
 *

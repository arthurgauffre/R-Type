 ...
 * @return The key bound to the action, or sf::Keyboard::Unknown if the action is not found.
 */
sf::Keyboard::Key component::InputComponent::getBoundKey(const std::string &action) const
{
 ...
 */
bool component::InputComponent::isActionActive(const std::string &action) const
{

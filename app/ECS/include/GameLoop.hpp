...
namespace game
{
    ...
    {
    public:
        GameLoop(int width, int height, const std::string &title) : _width(width), _height(height), _title(title)
        {
        ...
        component::ComponentManager &getComponentManager() { return _componentManager; }

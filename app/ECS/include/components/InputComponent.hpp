...
namespace component
{
    ...
    public:
         ...
         *
         * @param entityID The unique identifier of the entity associated with this component.
         */
         ...
         */
        void bindAction(const std::string &action, sf::Keyboard::Key key) { _keyBindings[action] = key; }
    ...
    private:
         ...
         *
         * The key is a string representing the action (e.g., "MoveLeft"), and the value
         * is the key from the keyboard associated with that action.
         */

...
namespace component
{
    ...
    {
    public:
        BackgroundComponent(uint32_t entityID, const sf::Texture &texture, const sf::Vector2f &size);
    ...
    private:
        /**
         * @brief A sprite object from the SFML library used to represent the background.
         * 

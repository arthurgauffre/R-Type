...
namespace component
{
    ...
    public:
         ...
         * @param scale The scale of the entity as a 2D vector. Defaults to {1.0f, 1.0f}.
         */
        TransformComponent(uint32_t entityID, sf::Vector2f position, sf::Vector2f scale = {1.0f, 1.0f})
            : AComponent(entityID), _position(position), _scale(scale), _rotation(0.0f) {};
         ...
         *
         * @param position A constant reference to an sf::Vector2f representing the new position.
         */
         ...
         *
         * @param scale A constant reference to an sf::Vector2f representing the new scale.
         */
    ...
    private:
         ...
         *
         * This class is part of the SFML (Simple and Fast Multimedia Library) and is used to define
         * positions, velocities, and other 2D vector quantities. It contains two public member variables:
         * x and y, which represent the x-coordinate and y-coordinate of the vector, respectively.
         */

...
namespace ECS_system
{
    ...
    public:
         ...
         *
         * This function is called to update the state of the collision system based on the
         * elapsed time and the list of entities provided. It overrides the base class
         * update method.
         *
         * @param deltaTime The time elapsed since the last update, in seconds.
         * @param entities A vector of shared pointers to the entities that need to be updated.
         */
         ...
         * for managing and updating the collision components in the system. The actual
    ...
    private:
         ...
         *
         * This function processes the collision logic between two given hitbox components.
         * It determines the outcome of the collision and applies necessary changes to the
         * involved entities.
         *
         * @param hitbox1 Pointer to the first hitbox component involved in the collision.
         * @param hitbox2 Pointer to the second hitbox component involved in the collision.
         */

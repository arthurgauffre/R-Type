...
namespace rtype
{
  ...
  public:
    ...
    public:
      ...
      {
        using FuncPtr = std::shared_ptr<T> (*)(Args...); // Define the function pointer type returning shared_ptr
        ...
        FuncPtr createFunc = reinterpret_cast<FuncPtr>(sym); // Cast to the correct function pointer type

...
namespace rtype
{
  ...
  public:
    ...
    public:
      ...
      std::shared_ptr<ECS_system::ISystem> getInstance(const std::string &funcName, Args &&...args)
      {
        using FuncPtr = std::shared_ptr<ECS_system::ISystem> (*)(Args...); // Function pointer type
        ...
        return createFunc(std::forward<Args>(args)...);      // Call function and return the shared_ptr
      }

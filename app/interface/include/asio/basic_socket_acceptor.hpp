...
public:
  ...
  typedef typename detail::null_socket_service<Protocol>::native_handle_type
      native_handle_type;
#elif defined(ASIO_HAS_IOCP)
  typedef typename detail::win_iocp_socket_service<Protocol>::native_handle_type
      native_handle_type;
#elif defined(ASIO_HAS_IO_URING_AS_DEFAULT)
  typedef typename detail::io_uring_socket_service<Protocol>::native_handle_type
      native_handle_type;
#else
  ...
  basic_socket_acceptor(const executor_type &ex, const protocol_type &protocol,
      ...
      : impl_(0, ex) {
    asio::error_code ec;
    impl_.get_service().assign(impl_.get_implementation(), protocol,
                               native_acceptor, ec);
  ...
  void native_non_blocking(bool mode) {
    asio::error_code ec;
    impl_.get_service().native_non_blocking(impl_.get_implementation(), mode,
                                            ec);
  ...
  endpoint_type local_endpoint() const {
    asio::error_code ec;
    endpoint_type ep =
        impl_.get_service().local_endpoint(impl_.get_implementation(), ec);
  ...
  void accept(basic_socket<Protocol1, Executor1> &peer,
    ...
    asio::error_code ec;
    impl_.get_service().accept(impl_.get_implementation(), peer,
                               static_cast<endpoint_type *>(0), ec);
  ...
  template <typename Protocol1, typename Executor1>
  ASIO_SYNC_OP_VOID
  accept(basic_socket<Protocol1, Executor1> &peer, asio::error_code &ec,
         constraint_t<is_convertible<Protocol, Protocol1>::value> = 0) {
    impl_.get_service().accept(impl_.get_implementation(), peer,
                               static_cast<endpoint_type *>(0), ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  ...
  auto async_accept(
      ...
      constraint_t<is_convertible<Protocol, Protocol1>::value> = 0)
      -> decltype(async_initiate<AcceptToken, void(asio::error_code)>(
          declval<initiate_async_accept>(), token, &peer,
          static_cast<endpoint_type *>(0))) {
    return async_initiate<AcceptToken, void(asio::error_code)>(
        initiate_async_accept(this), token, &peer,
        static_cast<endpoint_type *>(0));
  }
  ...
  void accept(basic_socket<protocol_type, Executor1> &peer,
    ...
    asio::error_code ec;
    impl_.get_service().accept(impl_.get_implementation(), peer, &peer_endpoint,
                               ec);
    asio::detail::throw_error(ec, "accept");
  }
  ...
  accept(const Executor1 &ex,
         constraint_t<is_executor<Executor1>::value ||
                      execution::is_executor<Executor1>::value> = 0) {
    asio::error_code ec;
    typename Protocol::socket::template rebind_executor<Executor1>::other peer(
        ex);
    impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
    asio::detail::throw_error(ec, "accept");
    return peer;
  ...
  auto async_accept(
      ...
      -> decltype(async_initiate<
                  ...
                  void(asio::error_code,
                       typename Protocol::socket::template rebind_executor<
                           Executor1>::other)>(
          declval<initiate_async_move_accept>(), token, ex,
          static_cast<endpoint_type *>(0),
          static_cast<typename Protocol::socket::template rebind_executor<
              Executor1>::other *>(0))) {
    return async_initiate<MoveAcceptToken,
                          void(asio::error_code,
                               typename Protocol::socket::
                                   template rebind_executor<Executor1>::other)>(
        initiate_async_move_accept(this), token, ex,
        static_cast<endpoint_type *>(0),
        static_cast<typename Protocol::socket::template rebind_executor<
            Executor1>::other *>(0));
  }
  ...
  auto async_accept(
      ...
      -> decltype(async_initiate<
                  ...
                  void(asio::error_code,
                       typename Protocol::socket::template rebind_executor<
                           typename ExecutionContext::executor_type>::other)>(
          declval<initiate_async_move_accept>(), token, context.get_executor(),
          static_cast<endpoint_type *>(0),
          static_cast<typename Protocol::socket::template rebind_executor<
    ...
    return async_initiate<
        ...
        void(asio::error_code,
             typename Protocol::socket::template rebind_executor<
                 typename ExecutionContext::executor_type>::other)>(
        initiate_async_move_accept(this), token, context.get_executor(),
        static_cast<endpoint_type *>(0),
        static_cast<typename Protocol::socket::template rebind_executor<
            typename ExecutionContext::executor_type>::other *>(0));
  }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const executor_type &ex, endpoint_type &peer_endpoint,
         asio::error_code &ec,
         constraint_t<is_executor<Executor1>::value ||
                      execution::is_executor<Executor1>::value> = 0) {
    typename Protocol::socket::template rebind_executor<Executor1>::other peer(
...
private:
  ...
  public:
    ...
    void operator()(MoveAcceptHandler &&handler, const Executor1 &peer_ex,
      ...
      ASIO_MOVE_ACCEPT_HANDLER_CHECK(MoveAcceptHandler, handler, Socket)
      type_check;
...
#elif defined(ASIO_HAS_IOCP)
  detail::io_object_impl<detail::win_iocp_socket_service<Protocol>, Executor>
      impl_;
#elif defined(ASIO_HAS_IO_URING_AS_DEFAULT)
  detail::io_object_impl<detail::io_uring_socket_service<Protocol>, Executor>
      impl_;
#else
  detail::io_object_impl<detail::reactive_socket_service<Protocol>, Executor>
      impl_;
#endif
};

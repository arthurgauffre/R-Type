...
struct relationship_t {
  ...
  friend constexpr bool operator==(const relationship_t &a,
...
template <int I = 0> struct relationship_t {
  ...
  template <typename T>
  static constexpr typename traits::static_query<T, fork_t>::result_type
  static_query(
  ...
  template <typename T>
  static constexpr typename traits::static_query<T, continuation_t>::result_type
  static_query(enable_if_t<!query_static_constexpr_member<T>::is_valid> * = 0,
               enable_if_t<!query_member<T>::is_valid> * = 0,
               enable_if_t<!traits::static_query<T, fork_t>::is_valid> * = 0,
               enable_if_t<traits::static_query<T, continuation_t>::is_valid>
                   * = 0) noexcept {
  ...
  friend constexpr relationship_t
  query(const Executor &ex, convertible_from_relationship_t,
...
template <int I = 0> struct continuation_t {
  ...
  template <typename T>
  struct query_member : traits::query_member<
  ...
  friend constexpr bool operator==(const continuation_t &,
                                   const continuation_t &) {
    return true;
  }
...
struct static_query<T, execution::relationship_t,
                    enable_if_t<execution::detail::relationship_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::relationship_t<
      0>::query_static_constexpr_member<T>::result_type result_type;

  static constexpr result_type value() {
    return execution::detail::relationship_t<0>::query_static_constexpr_member<
        T>::value();
  }
};
...
struct static_query<
    T, execution::relationship_t,
    enable_if_t<
        !execution::detail::relationship_t<0>::query_static_constexpr_member<
            T>::is_valid &&
  ...
  typedef typename traits::static_query<
      T, execution::relationship_t::fork_t>::result_type result_type;
...
struct static_query<
    ...
    enable_if_t<
        ...
        !traits::static_query<T, execution::relationship_t::fork_t>::is_valid &&
        traits::static_query<
            T, execution::relationship_t::continuation_t>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename traits::static_query<
      T, execution::relationship_t::continuation_t>::result_type result_type;

  static constexpr result_type value() {
    return traits::static_query<
        T, execution::relationship_t::continuation_t>::value();
  }
};

template <typename T>
struct static_query<T, execution::relationship_t::fork_t,
                    enable_if_t<execution::detail::relationship::fork_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::relationship::fork_t<
      0>::query_static_constexpr_member<T>::result_type result_type;

  static constexpr result_type value() {
    return execution::detail::relationship::fork_t<
...
struct static_query<
    ...
    enable_if_t<
        !execution::detail::relationship::fork_t<
            0>::query_static_constexpr_member<T>::is_valid &&
        !execution::detail::relationship::fork_t<0>::query_member<
            T>::is_valid &&
...
struct static_query<T, execution::relationship_t::continuation_t,
                    enable_if_t<execution::detail::relationship::continuation_t<
                        0>::query_static_constexpr_member<T>::is_valid>> {
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;

  typedef typename execution::detail::relationship::continuation_t<
      0>::query_static_constexpr_member<T>::result_type result_type;

  static constexpr result_type value() {
    return execution::detail::relationship::continuation_t<
        0>::query_static_constexpr_member<T>::value();
  }
};

...
public:
  template <typename Initiation, typename... InitArgs>
  static deferred_async_operation<deferred_signatures<Signatures...>,
                                  Initiation, InitArgs...>
  initiate(Initiation &&initiation, deferred_t, InitArgs &&...args) {
    return deferred_async_operation<deferred_signatures<Signatures...>,
                                    Initiation, InitArgs...>(
        deferred_init_tag{}, static_cast<Initiation &&>(initiation),
        static_cast<InitArgs &&>(args)...);
  }
...
public:
  ...
  static auto initiate(Initiation &&initiation,
    ...
    return deferred_sequence<
        deferred_async_operation<Signature, Initiation, InitArgs...>, Function>(
        deferred_init_tag{},
        deferred_async_operation<Signature, Initiation, InitArgs...>(
            deferred_init_tag{}, static_cast<Initiation &&>(initiation),
            static_cast<InitArgs &&>(init_args)...),
...
public:
  ...
  static auto initiate(Initiation &&initiation,
                       ...
                       InitArgs &&...init_args)
      -> decltype(deferred_sequence<
                  deferred_async_operation<deferred_signatures<Signatures...>,
                                           Initiation, InitArgs...>,
                  Function>(
          deferred_init_tag{},
          deferred_async_operation<deferred_signatures<Signatures...>,
          ...
          static_cast<Function &&>(token.function_))) {
    return deferred_sequence<
        deferred_async_operation<deferred_signatures<Signatures...>, Initiation,
                                 InitArgs...>,
...
template <template <typename, typename> class Associator, typename Handler,
          typename Tail, typename DefaultCandidate>
struct associator<Associator, detail::deferred_sequence_handler<Handler, Tail>,
                  DefaultCandidate> : Associator<Handler, DefaultCandidate> {
  static typename Associator<Handler, DefaultCandidate>::type
  get(const detail::deferred_sequence_handler<Handler, Tail> &h) noexcept {

...
inline bool
asio_handler_is_continuation(as_tuple_handler<Handler> *this_handler) {
...
struct associator<Associator, detail::as_tuple_handler<Handler>,
                  DefaultCandidate> : Associator<Handler, DefaultCandidate> {
  static typename Associator<Handler, DefaultCandidate>::type
  get(const detail::as_tuple_handler<Handler> &h) noexcept {

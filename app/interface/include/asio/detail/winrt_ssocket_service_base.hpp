...
public:
  ...
  asio::error_code non_blocking(base_implementation_type &, bool,
                                asio::error_code &ec) {
    ec = asio::error::operation_not_supported;
    return ec;
  }
  ...
  asio::error_code native_non_blocking(base_implementation_type &, bool,
                                       asio::error_code &ec) {
    ec = asio::error::operation_not_supported;
    return ec;
  }
  ...
  void async_send(base_implementation_type &impl,
    ...
    ASIO_HANDLER_CREATION(
        (scheduler_.context(), *p.p, "socket", &impl, 0, "async_send"));
  ...
  void async_receive(base_implementation_type &impl,
    ...
    ASIO_HANDLER_CREATION(
        (scheduler_.context(), *p.p, "socket", &impl, 0, "async_receive"));
...
protected:
  ...
  ASIO_DECL std::size_t do_get_endpoint(const base_implementation_type &impl,
                                        bool local, void *addr,
                                        std::size_t addr_len,
                                        asio::error_code &ec) const;

  // Helper function to set a socket option.
  ASIO_DECL asio::error_code
  do_set_option(base_implementation_type &impl, int level, int optname,
                const void *optval, std::size_t optlen, asio::error_code &ec);

  // Helper function to get a socket option.
  ASIO_DECL void do_get_option(const base_implementation_type &impl, int level,
  ...
  ASIO_DECL void start_connect_op(base_implementation_type &impl,
                                  const void *addr, winrt_async_op<void> *op,

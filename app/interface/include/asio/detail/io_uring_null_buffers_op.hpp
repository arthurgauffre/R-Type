...
public:
  ...
  io_uring_null_buffers_op(const asio::error_code &success_ec, int descriptor,
                           int poll_flags, Handler &handler,
                           const IoExecutor &io_ex)
      : io_uring_operation(success_ec, &io_uring_null_buffers_op::do_prepare,
        ...
        descriptor_(descriptor), poll_flags_(poll_flags) {}

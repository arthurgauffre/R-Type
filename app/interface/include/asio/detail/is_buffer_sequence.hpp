...
char (&buffer_sequence_begin_helper(
    T *t, enable_if_t<!is_same<decltype(asio::buffer_sequence_begin(*t)),
                               void>::value> *))[2];
...
char (&buffer_sequence_end_helper(
    T *t,
    enable_if_t<!is_same<decltype(asio::buffer_sequence_end(*t)), void>::value>
        *))[2];
...
char buffer_sequence_element_type_helper(
    T *t, enable_if_t<is_convertible<decltype(*asio::buffer_sequence_begin(*t)),
                                     Buffer>::value> *);

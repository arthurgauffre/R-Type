...
public:
  ...
  void move_assign(implementation_type &impl,
                   ...
                   implementation_type &other_impl) {
    descriptor_service_.move_assign(impl, other_service.descriptor_service_,
                                    other_impl);
    impl.is_stream_ = other_impl.is_stream_;
  }
  ...
  ASIO_DECL asio::error_code open(implementation_type &impl, const char *path,
  ...
  ASIO_DECL asio::error_code resize(implementation_type &impl, uint64_t n,
                                    asio::error_code &ec);
  ...
  void async_write_some_at(implementation_type &impl, uint64_t offset,
                           const ConstBufferSequence &buffers, Handler &handler,
                           const IoExecutor &io_ex) {
    descriptor_service_.async_write_some_at(impl, offset, buffers, handler,
                                            io_ex);
  }
  ...
  void async_read_some_at(implementation_type &impl, uint64_t offset,
    ...
    descriptor_service_.async_read_some_at(impl, offset, buffers, handler,
                                           io_ex);
  }

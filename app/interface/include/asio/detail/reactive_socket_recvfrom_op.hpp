...
public:
  reactive_socket_recvfrom_op_base(const asio::error_code &success_ec,
      ...
      : reactor_op(success_ec, &reactive_socket_recvfrom_op_base::do_perform,
                   complete_func),
        socket_(socket), protocol_type_(protocol_type), buffers_(buffers),
        sender_endpoint_(endpoint), flags_(flags) {}
